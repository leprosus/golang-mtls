...
var (
	pubBs    = []byte{112, 75, 111, 206, 158, 65, 176, 187, 106, 181, 240, 128, 199, 181, 22, 181, 24, 150, 159, 145, 142, 81, 193, 2, 195, 235, 51, 175, 132, 66, 3, 242}
	edPub    = ed25519.PublicKey(pubBs)
	pub      = domain.PublicKey(edPub)
	pubX509  = []byte{48, 42, 48, 5, 6, 3, 43, 101, 112, 3, 33, 0, 112, 75, 111, 206, 158, 65, 176, 187, 106, 181, 240, 128, 199, 181, 22, 181, 24, 150, 159, 145, 142, 81, 193, 2, 195, 235, 51, 175, 132, 66, 3, 242}
	pubCurve = []byte{237, 232, 55, 115, 58, 10, 154, 213, 180, 62, 195, 43, 131, 109, 0, 9, 63, 13, 22, 77, 4, 76, 27, 74, 26, 166, 67, 145, 62, 53, 98, 120}
